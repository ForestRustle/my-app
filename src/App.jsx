...
function App() {
    ...
    React.useEffect(() => {
        ...
        const tyrsData = await axios.get('https://637f91cc5b1cc8d6f949a307.mockapi.io/tyrs')
       const cartData = await axios.get('https://637f91cc5b1cc8d6f949a307.mockapi.io/cart')
       const favoritesData = await axios.get('https://637f91cc5b1cc8d6f949a307.mockapi.io/favorites')
    ...
    const deleteItems=(id)=>{
        console.log(id);
        axios.delete(`https://637f91cc5b1cc8d6f949a307.mockapi.io/cart/${id}`)
